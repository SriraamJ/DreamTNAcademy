      ...
      <Container maxWidth="lg">
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
            ...
            >
              <Box sx={{ mb: 3 }}>
                ...
                >
                  ...
                  <br />
                  Dream TN Dept. Academy
                </Typography>
                
              </Box>
              <Box sx={{ mb: 4, width: { xs: '100%', md: '90%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6, size: 30}}>
                  {
                    "துன்பங்கள் எது வந்த போதிலும் லட்சியம் காக்கி மட்டுமே"
                  }
                </Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
                  <StyledButton color="primary" size="large" variant="contained">
                  Dream Big. Prepare Smart. Achieve Success!
                  </StyledButton>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            <Box sx={{ lineHeight: 0 }}>
              <Image src="/images/headerImage.webp" width={775} height={787} alt="Hero img" />
            </Box>
          </Grid>
        </Grid>
